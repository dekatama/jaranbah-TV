...
class _AgeSettingsTileState extends State<AgeSettingsTile> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
        ...
        title:
            Text(AppLocalizations.of(context).translate(TR_PARENTAL_CONTROL)),
        subtitle:
            Text(AppLocalizations.of(context).translate(TR_AGE_RESTRICTION)),
        onTap: () => _onTap(),
        trailing: Padding(
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
        title: Text(!authorized
            ? _translate(TR_PARENTAL_CONTROL)
            : _translate(TR_AGE_RESTRICTION)),
