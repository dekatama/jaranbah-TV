...
abstract class IStreamBaseListPage<T extends IStream, U extends StatefulWidget>
    extends State<U> with TickerProviderStateMixin {
          ...
          return Center(
              ...
              child: SizedBox(
                  ...
                  child: Column(children: <Widget>[
                    _makeTabBar(),
                    Expanded(child: _makeTabListPage())
                  ])));
        });
  }
  ...
  Widget _makeTabBar() {
    ...
    final tabBar = TabBarEx(tabController,
        List<String>.generate(categories.length, (index) => categories[index]));
  ...
  void _initTabController() {
    ...
    tabController = TabController(
        vsync: this, length: channelsMap.length, initialIndex: init);
  ...
  void handleFavorite(bool value, T stream) =>
      bloc.handleFavorite(value, stream);
