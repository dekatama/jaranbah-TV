...
abstract class EditStreamPageState<T extends IStream>
    extends State<EditStreamPage<T>> {
  ...
  void initState() {
    ...
    nameController = TextEditingController(
        text: AppLocalizations.toUtf8(widget.stream.displayName()));
    iconController = TextEditingController(text: widget.stream.icon());
    videoLinkController =
        TextEditingController(text: widget.stream.primaryUrl());
    iarcController =
        TextEditingController(text: widget.stream.iarc().toString());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text(translate(context, appBarTitle),
  ...
  List<Widget> content() {
    return <Widget>[
      ...
      groupsField(),
      textField(TR_EDIT_VIDEO_LINK, videoLinkController,
    ...
    return !validator
        ...
        : FloatingActionButton(
            ...
            child: Icon(Icons.save,
                color: backgroundColorBrightness(accentColor)));
  }
  ...
  Widget textField(String hintText, TextEditingController controller,
    ...
    return TextFormField(
        ...
        decoration: InputDecoration(
            labelText: translate(context, hintText) ?? hintText),
