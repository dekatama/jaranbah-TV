...
class _VodDescriptionState extends State<VodDescription> {
        ...
        SizedBox(
            ...
            child: Row(children: <Widget>[
              Padding(
                  ...
                  child: SizedBox(
                      width: 180,
                      child: PreviewIcon.vod(currentVod.previewIcon()))),
                ...
                child: Column(children: <Widget>[
                  Expanded(
                      ...
                      child: Padding(
                          ...
                          child: Center(
                              child:
                                  PreviewIcon.vod(currentVod.previewIcon())))),
  ...
  Widget playButton(VodStream currentVod, {double padding}) {
    return Padding(
        padding: EdgeInsets.symmetric(horizontal: padding ?? 8),
        child: VodPlayButton(currentVod));
  }

  Widget description(VodStream currentVod) {
    return Flexible(
        child: VodDescriptionText(
            AppLocalizations.toUtf8(currentVod.description())));
  }
