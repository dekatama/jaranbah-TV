...
import 'package:jarambahtv/base/streams/programs_list.dart';
import 'package:jarambahtv/channels/live_stream.dart';
import 'package:jarambahtv/player/controller.dart';
import 'package:jarambahtv/player/mobile_player.dart';
...
class _ChannelPageState extends PlayerPageMobileState<ChannelPage> {
  ...
  void _playChannel() {
    if (castConnected) {
      ChromeCastInfo().initVideo(_currentChannel.primaryUrl(),
          AppLocalizations.toUtf8(_currentChannel.displayName()));
    } else {
