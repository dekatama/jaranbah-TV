...
import 'package:jarambahtv/mobile/mobile_search.dart';
...
class LiveStreamSearch extends IStreamSearchDelegate<LiveStream> {
  LiveStreamSearch(List<LiveStream> results, String hint)
      : super(results, hint);
  ...
  Widget list(List<LiveStream> results) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) => ListTile(
            leading:
                PreviewIcon.live(results[index].icon(), height: 40, width: 40),
