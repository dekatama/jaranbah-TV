import 'package:jarambahtv/base/add_streams/m3u_file_picker.dart';
...
import 'package:jarambahtv/mobile/add_streams/select_stream_page.dart';
import 'package:jarambahtv/mobile/streams/live_edit_channel.dart';
...
import 'package:jarambahtv/tv/add_streams/tv_select_stream_page.dart';
import 'package:jarambahtv/tv/streams/tv_live_edit_channel.dart';
import 'package:jarambahtv/tv/vods/tv_vod_edit_channel.dart';
...
abstract class BaseFilePickerDialogState extends State<BaseFilePickerDialog> {
  ...
  Widget _button(String text, void Function() onPressed) {
    ...
    return FlatButton(
        ...
        child: Text(text,
            style: hasTouch
                ? TextStyle(
                    color: backgroundColorBrightness(
  ...
  void _addStream() async {
    ...
    if (_streamType == StreamType.Live) {
      final LiveStream _response = await Navigator.of(context).push(
          MaterialPageRoute(
              builder: (context) => hasTouch
      ...
      final VodStream _response = await Navigator.of(context).push(
          MaterialPageRoute(
              builder: (context) => hasTouch
