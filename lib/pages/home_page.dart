...
import 'package:jarambahtv/mobile/streams/live_search.dart';
import 'package:jarambahtv/mobile/vods/vod_search.dart';
...
abstract class VideoAppState extends State<HomePage> {
  ...
  void _fillTypes() {
    ...
    if (lastType != null) {
      selectedType =
          videoTypesList.contains(lastType) ? lastType : videoTypesList[0];
    } else {
