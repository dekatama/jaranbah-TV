import 'package:jarambahtv/base/focusable/border.dart';
import 'package:jarambahtv/base/vods/vod_description.dart';
...
import 'package:jarambahtv/tv/vods/tv_vod_player.dart';
...
class _TvVodDescriptionState extends State<TvVodDescription> {
  ...
  Widget _playButton() {
    return Padding(
        ...
        child: SizedBox(
            width: 96,
            child: VodPlayButton(widget.channel,
                onTap: _onPlayTapped, focus: playNode)));
  }
  ...
  Widget _score() {
    return UserScore(widget.channel.userScore(),
  ...
  Widget _info() {
    return Focus(
        ...
        child: FocusBorder(
            ...
            child: SideInfo(
                country:
                    AppLocalizations.toUtf8(widget.channel.country() ?? ''),
