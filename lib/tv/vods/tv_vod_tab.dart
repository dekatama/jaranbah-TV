...
class _TVVodPageState extends State<TVVodPage> with TickerProviderStateMixin {
  ...
  void _initTabController() async {
    _tabController = TabController(
        vsync: this, length: channelsMap.keys.length, initialIndex: 2);
  }
  ...
  void initState() {
    ...
    _search
        .subscribe<StreamSearchEvent<VodStream>>()
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
        ...
        child: Column(children: <Widget>[
          ...
          Expanded(
              child: TabBarView(
                  controller: _tabController, children: _generateList()))
        ]));
  }
  ...
  Widget _tabBar() {
    ...
    final inactive = TextStyle(
        ...
        color: Theming.of(context)
            .onBrightness(light: Colors.black87, dark: Colors.white70),
            ...
            child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Padding(
                      ...
                      child: Center(
                          child: _CardWrap(
                              node, _onCard, CARD_WIDTH_TV, BORDER_WIDTH)));
                })));
  }
  ...
  void _onCardTap(VodStream channel) async {
    ...
    await Navigator.push(context,
        MaterialPageRoute(builder: (context) => TvVodDescription(channel)));
      ...
      switch (rawKeyEventDataAndroid.keyCode) {
        ...
        case KEY_LEFT:
          if (FocusScope.of(context).focusedChild.offset.dx > CARD_WIDTH_TV) {
            ...
            while (MediaQuery.of(context).size.width -
                    FocusScope.of(context).focusedChild.offset.dx >
                CARD_WIDTH_TV * 2) {
        ...
        case KEY_RIGHT:
          if (MediaQuery.of(context).size.width -
            ...
            while (
                FocusScope.of(context).focusedChild.offset.dx > CARD_WIDTH_TV) {
              FocusScope.of(context).focusInDirection(TraversalDirection.left);
            }
