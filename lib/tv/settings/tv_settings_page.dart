...
import 'package:jarambahtv/tv/settings/tv_age_picker.dart';
import 'package:jarambahtv/tv/settings/tv_language_picker.dart';
import 'package:jarambahtv/tv/settings/tv_padding.dart';
import 'package:jarambahtv/tv/settings/tv_theming.dart';
import 'package:jarambahtv/tv/settings/tv_time_format.dart';
...
class _SettingPageTVState extends State<SettingPageTV> {
  ...
  Widget build(BuildContext context) {
    ...
    final verticalDivider =
        SizedBox(height: listHeight, child: const VerticalDivider(width: 0));
          ...
          Scaffold(
              appBar: AppBar(
                  ...
                  title: Text(
                      ...
                      style:
                          TextStyle(color: Theming.of(context).onBrightness())),
                  centerTitle: true),
              body: Row(mainAxisAlignment: MainAxisAlignment.center, children: <
                ...
                Container(
                    ...
                    constraints: const BoxConstraints(
                        minHeight: TV_LIST_ITEM_SIZE * 5.0),
