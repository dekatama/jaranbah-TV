import 'package:jarambahtv/base/login/textfields.dart';
...
class _AgePickerTVState extends State<AgePickerTV> {
  ...
  Widget ageWidget() {
    return ListTile(
        ...
        leading:
            Icon(Icons.child_care, color: Theming.of(context).onBrightness()),
  ...
  Widget build(BuildContext context) {
    final color =
        _pickerNode.hasPrimaryFocus ? Theme.of(context).accentColor : null;
    return Column(
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            title: Text(_translate(TR_PARENTAL_CONTROL),
                style: TextStyle(
                    color:
                        Theming.onCustomColor(Theme.of(context).primaryColor))),
            centerTitle: true),
        body: Center(
            child: SizedBox(
