...
class ChannelsListTVState extends State<ChannelsListTV> {
            ...
            child: Row(
                ...
                children: <Widget>[
                  Icon(Icons.keyboard_arrow_left,
                      color: _color ?? Theme.of(context).disabledColor),
  ...
  Widget channelsList() {
    final _size =
        Size(widget.size.width, widget.size.height - LIST_HEADER_SIZE);
...
class _ChannelTile extends StatefulWidget {
  ...
  const _ChannelTile(
      {@required this.channel, @required this.onKey, this.itemHeight});
...
class _NoChannels extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final child = NonAvailableBuffer(
        iconSize: 48, icon: _typeIcon(), message: _typeMessage());
    return SizedBox(
